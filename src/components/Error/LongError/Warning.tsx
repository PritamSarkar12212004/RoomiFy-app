...
const Warning = ({ closewarning, setclosewarning,message }: any) => {
  return (
    <>
      {closewarning ? (
        <View className="w-full z-50 h-screen flex items-center absolute top-0 left-0 justify-center   blur-md bg-black/60">
          <View className="w-72 h-80 bg-white rounded-3xl justify-center items-center shadow-slate-200">
            ...
            <TouchableOpacity
              ...
              className="w-[80%] flex items-center justify-center shadow-black  drop-shadow-lg py-4 mt-5 bg-yellow-400 rounded-3xl"
              activeOpacity={0.8}
            >
